...
{
  /// <summary>
  /// Outlines core functionality for user account administration
  /// </summary>
  public interface IIdpUserAdminLogic : IBusinessLogic
  {
    /// <summary>
  ...
  /// </summary>
  public interface IIdpUserCoreLogic : IBusinessLogic, IMinIdpStore, IIdpUserAdminLogic
  {
    /// <summary>
