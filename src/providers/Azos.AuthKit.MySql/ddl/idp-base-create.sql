...
(
  ...
  `LAST_OK_UTC`    DATETIME     not null  comment 'Last correct login timestamp or null',
  `LAST_OK_ADDR`   VARCHAR(32)  not null  comment 'Last correct login timestamp or null',

  `LAST_BAD_UTC`   DATETIME         comment 'Last incorrect login timestamp or null',
  `LAST_BAD_ADDR`  VARCHAR(32)      comment 'Last correct login timestamp or null',
