...
namespace Azos.Erlang
{
  ...
  public static class ErlObject
  {
    ...
    public static object AsType(this IErlObject val, Type t)
    {
      ...
      {
        throw new ErlException(StringConsts.ERL_CANNOT_CONVERT_TYPES_ERROR.Args(val.GetType().Name, t.FullName), e);
      }
    ...
    public static IErlObject ToErlObject(this object o)
    {
      ...
      if (ts_Refs == null)
        ts_Refs = new HashSet<object>(Collections.ReferenceEqualityComparer<object>.Instance);
