...
namespace Azos.Erlang
{
  ...
  #region Props
    ...
    public DateTime    ValueAsDateTime { get { if (m_Value==0) return DateUtils.UNIX_EPOCH_START_DATE; else throw new ErlIncompatibleTypesException(this, typeof(DateTime)); } }
