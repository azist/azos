...
namespace Azos.Data.Access.Oracle
{
  ...
  public class OracleCanonicalDataStore : OracleCRUDDataStoreBase, ICRUDDataStoreImplementation
  {
    ...
    #region ICRUDDataStore
        ...
        {
            return new OracleCRUDScriptQueryHandler(this, querySource);
        }
    ...
    #region Protected + Overrides
        ...
        /// </summary>
        protected internal virtual Schema DoGetSchema(OracleConnection cnn, OracleTransaction transaction, Query query)
        {
            ...
            try
            {
              return handler.GetSchema( new OracleCRUDQueryExecutionContext(this, cnn, transaction), query);
            }
        ...
        ///  Performs CRUD load. Override to do custom Query interpretation
        /// </summary>
        protected internal virtual Cursor DoOpenCursor(OracleConnection cnn, OracleTransaction transaction, Query query)
        {
        ...
        /// </summary>
        protected internal virtual int DoSave(OracleConnection cnn, OracleTransaction transaction, RowsetBase[] rowsets)
        {
        ...
        /// </summary>
        protected internal virtual int DoInsert(OracleConnection cnn, OracleTransaction transaction, Doc row, FieldFilterFunc filter = null)
        {
