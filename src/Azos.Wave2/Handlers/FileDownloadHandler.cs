...
namespace Azos.Wave.Handlers
{
  ...
  public class FileDownloadHandler : WorkHandler
  {
    ...
    protected FileDownloadHandler(WorkHandler director, string name, int order, WorkMatch match) : base(director, name, order, match)
    {
    }

    protected FileDownloadHandler(WorkHandler director, IConfigSectionNode confNode) : base(director, confNode)
    {
