...
namespace Azos.Instrumentation.Analytics
{
  ...
  public class Histogram<TData1, TData2, TData3> : Histogram
  {
    ...
    /// </summary>
    public override int DimensionCount => 3;

    /// <summary>
    /// Return the sample count associated with given histogram keys
    /// </summary>
    public int this[int k1, int k2, int k3] => this[new HistogramKeys(k1, k2, k3)];
    ...
    public bool TryGet(int k1, int k2, int k3, out int count)
      => TryGet(new HistogramKeys(k1, k2, k3), out count);
    ...
    public HistogramKeys Keys(TData1 value1, TData2 value2, TData3 value3)
      => new HistogramKeys(m_Dimension1[value1], m_Dimension2[value2], m_Dimension3[value3]);
