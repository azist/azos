...
namespace Azos.Instrumentation.Analytics
{
  ...
  public abstract class Dimension
  {
    ...
    public string GetPartitionName(int idx)
      => m_PartitionNameFunc == null ? DoPartitionName(idx) : m_PartitionNameFunc(idx);
    ...
    protected virtual string DoPartitionName(int idx)
      => DEFAULT_PARTITION_NAMES[(int)(((double)idx / (double)PartitionCount) * (DEFAULT_PARTITION_NAMES.Length - 1))];
  ...
  public class Dimension<TData> : Dimension
  {
    ...
    /// </summary>
    public int this[TData value] => m_PartitionFunc == null ? DoPartition(value) : m_PartitionFunc(this, value);
    ...
    /// </summary>
    protected virtual int DoPartition(TData value) => 0;
