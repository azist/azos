...
namespace Azos.Instrumentation.Analytics
{
  ...
  public struct HistogramKeys : IComparable<HistogramKeys>, IComparable
  {
    ...
    public override int GetHashCode() => Key1 + Key2 + Key3;
    ...
    public int this[int idx]
    {
      get
      {
        switch (idx)
        {
          ...
          case 1: return Key2;
          case 2: return Key3;
          default: throw new AzosException(StringConsts.ARGUMENT_ERROR + "idx[" + idx + "]");
        }
      }
    }
    ...
    public int CompareTo(object obj) => CompareTo((HistogramKeys)obj);
  ...
  public class HistogramEntry
  {
    ...
    public HistogramKeys BucketKeys => m_BucketKeys;
  ...
  public abstract class Histogram : IHistogram
  {
    ...
    public Dimension GetDimention(int dimension)
    {
      ...
      if (dim == null)
        throw new AzosException(StringConsts.ARGUMENT_ERROR + "dimension");
    ...
    /// Histogram title used for displaying purposes
    /// </summary>
    public virtual string Title => m_Title ?? GetType().FullName;

    /// <summary>
    /// Total number of samples in the histogram
    /// </summary>
    public long TotalSamples => m_TotalSamples;
    ...
    public override string ToString() => Title ?? GetType().FullName;

    public override int GetHashCode() => m_Data.GetHashCode() * DimensionCount;

    public IEnumerator<HistogramEntry> GetEnumerator() => m_Data.Values.GetEnumerator();
    ...
    protected Dimension this[int dimIndex] => GetDimention(dimIndex);
