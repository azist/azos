...
namespace Azos.CodeAnalysis
{
  ...
  public class LazyFSMState<TToken> : Hashtable where TToken : Token
  {
    ...
    /// </summary>
    public bool OnlyPrimary => m_OnlyPrimary;

    /// <summary>
    /// Returns an index for token that machine is on now
    /// </summary>
    public int CurrentTokenIndex => m_CurrentTokenIndex;
    ...
    /// </summary>
    public int PatternTokenLength => m_PatternTokenLength;

    /// <summary>
    /// Returns token enumerable that analysis is performed on
    /// </summary>
    public IEnumerable<TToken> Tokens => m_Tokens;
