...
namespace Azos.CodeAnalysis.Laconfig
{
  ...
  public class LaconfigToken : Token
  {
    ...
    public override bool IsPrimary => !IsNonLanguage && Type != LaconfigTokenType.tComment;

    public override bool IsNonLanguage => Type > LaconfigTokenType.NONLANG_START && Type < LaconfigTokenType.NONLANG_END;

    public override int OrdinalType => (int)Type;

    public override bool IsTextualLiteral => Type == LaconfigTokenType.tStringLiteral;

    public override bool IsNumericLiteral => false;
