...
namespace Azos.CodeAnalysis
{
  ...
  public abstract class Lexer<TToken> : SourceRefCommonCodeProcessor, ILexer, IEnumerable<TToken> where TToken : Token
  {
    ...
    /// </summary>
    public ISourceText Source => m_Source;
    ...
    /// </summary>
    public bool AllAnalyzed => m_AllAnalyzed;
    ...
    /// lexical analysis token-by-token or in chunks with every enumerator advance
    /// </summary>
    public IEnumerable<Token> TokenStream => this;

    public IEnumerator<TToken> GetEnumerator() => new tokenEnumerator(this);
    ...
    /// </summary>
    public void AnalyzeAll() => analyzeAll();
    ...
    private class tokenEnumerator : IEnumerator<TToken>
    {
      ...
      public TToken Current => m_Lexer.m_Tokens[m_Index];
