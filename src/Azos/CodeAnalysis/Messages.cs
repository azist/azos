...
namespace Azos.CodeAnalysis
{
  ...
  public sealed class Message
  {
    ...
    /// </summary>
    public bool IsInternal => Type < MessageType.Info || Type >= MessageType.InternalError;

    /// <summary>
    /// Indicates whether this message is an info message
    /// </summary>
    public bool IsInfo => (Type >= MessageType.Info) && (Type < MessageType.Warning);

    /// <summary>
    /// Indicates whether this message is a warning message
    /// </summary>
    public bool IsWarning => (Type >= MessageType.Warning) && (Type < MessageType.Error);
  ...
  public class MessageList : List<Message>
  {
    ...
    /// </summary>
    public IEnumerable<Message> Internals => this.Where(msg => msg.IsInternal);

    /// <summary>
    /// Enumerates all info messages
    /// </summary>
    public IEnumerable<Message> Infos => this.Where(msg => msg.IsInfo);

    /// <summary>
    /// Enumerates all warning messages
    /// </summary>
    public IEnumerable<Message> Warnings => this.Where(msg => msg.IsWarning);

    /// <summary>
    /// Enumerates all error messages
    /// </summary>
    public IEnumerable<Message> Errors => this.Where(msg => msg.IsError);
