...
//  /// </summary>
//  public interface IMetabizLogic : IBusinessLogic
//  {
//    /// <summary>
...
//    Task<IEnumerable<VersionInfo>> GetNodeVersionListAsync(MetabizPath path);
...
//    Task<MetabizNodeInfo> GetNodeInfoVersionAsync(MetabizPath path, GDID gVersion);
...
//    /// <param name="cache">Controls cache options used by the call, such as bypass cache etc.</param>
//    /// <returns>Enumerable of <see cref="ListItem"/> objects</returns>
//    Task<IEnumerable<ListItem>> GetChildNodeListAsync(MetabizPath idParent, DateTime? asOfUtc = null, ICacheParams cache = null);
...
//    Task<CorporateNodeInfo> GetNodeInfoAsync(MetabizPath id, DateTime? asOfUtc = null, ICacheParams cache = null);
...
//    Task<ChangeResult> DeleteNodeAsync(MetabizPath path, DateTime? startUtc = null);
//  }
//}
