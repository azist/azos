...
namespace Azos.Data.Idgen
{
  ...
  /// for the same sequence names. The era is set as an external parameter, so you should manually manage it.
  ...
  public sealed class LocalGdidGenerator : ApplicationComponent, IConfigurable, IGdidProvider
  {
    ...
    /// <summary>
    /// Assigns a cluster-unique id of the authority node which the class is allocated on.
