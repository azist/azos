...
namespace Azos.Data.Access
{
  ...
  ///   t1.lname like ?LN
  /// </example>
  public sealed class QuerySource : Collections.INamed
  {
    ...
    /// </summary>
    public class ColumnDef : Collections.INamed
    {
    ...
    private Collections.Registry<ColumnDef> m_Columns;
    ...
    private void parseLine(int no, string line, string name, string value)
    {
      ...
      throw new DataAccessException(StringConsts.CRUD_QUERY_SOURCE_PRAGMA_ERROR.Args(no, line, StringConsts.CRUD_QUERY_SOURCE_PRAGMA_LINE_ERROR.Args(name, value)));
    }
