...
////    public override bool Equals(object obj) => obj is Atc other ? this.Equals(other) : false;

////    public bool Equals(Atc other) => Value == other.Value;

////    public static bool operator ==(Atc a, Atc b) =>  a.Equals(b);
////    public static bool operator !=(Atc a, Atc b) => !a.Equals(b);
...
////    public static Atc Parse(string value)
////    {
////      throw new NotImplementedException();
////    }

////    public static bool TryParse(string str, out Atc value)
////    {
////      throw new NotImplementedException();
////    }
