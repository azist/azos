...
namespace Azos.Standards.Medical
{
  ...
  public struct UsGpi : IEquatable<UsGpi>, IRequired, IJsonReadable, IJsonWritable, IFormattable
  {
    ...
    public bool Equals(UsGpi other) => Value == other.Value;

    public static bool operator ==(UsGpi a, UsGpi b) => a.Equals(b);
    public static bool operator !=(UsGpi a, UsGpi b) => !a.Equals(b);
    ...
    public static UsGpi Parse(string value)
    {
      throw new NotImplementedException();
    }

    public static bool TryParse(string str, out UsGpi value)
    {
      throw new NotImplementedException();
    }
