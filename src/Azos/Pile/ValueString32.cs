...
namespace Azos.Pile
{
  ...
  /// </summary>
  public unsafe struct ValueString32 : IEquatable<ValueString32>, IEquatable<string>
  {
    public const int SIZE = 32;

    public ValueString32(string v)
    {
    ...
    public override bool Equals(object obj) => obj is ValueString32 vs ? this.Equals(vs) : false;
    ...
    public static bool operator ==(ValueString32 a, ValueString32 b) => a.Equals(b);
    public static bool operator !=(ValueString32 a, ValueString32 b) => !a.Equals(b);

    public static bool operator ==(ValueString32 a, string b) => a.Equals(b);
    public static bool operator !=(ValueString32 a, string b) => !a.Equals(b);

    public static bool operator ==(string a, ValueString32 b) => b.Equals(a);
    public static bool operator !=(string a, ValueString32 b) => !b.Equals(a);
  }
}
