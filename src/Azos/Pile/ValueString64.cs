...
namespace Azos.Pile
{
  ...
  /// </summary>
  public unsafe struct ValueString64 : IEquatable<ValueString64>, IEquatable<string>
  {
    public const int SIZE = 64;

    public ValueString64(string v)
    {
    ...
    public override bool Equals(object obj) => obj is ValueString64 vs ? this.Equals(vs) : false;
    ...
    public static bool operator ==(ValueString64 a, ValueString64 b) => a.Equals(b);
    public static bool operator !=(ValueString64 a, ValueString64 b) => !a.Equals(b);

    public static bool operator ==(ValueString64 a, string b) => a.Equals(b);
    public static bool operator !=(ValueString64 a, string b) => !a.Equals(b);

    public static bool operator ==(string a, ValueString64 b) => b.Equals(a);
    public static bool operator !=(string a, ValueString64 b) => !b.Equals(a);
  }
}
