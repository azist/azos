...
namespace Azos.Pile
{
  ...
  /// </summary>
  public unsafe struct ValueString24 : IEquatable<ValueString24>, IEquatable<string>
  {
    public const int SIZE = 24;

    public ValueString24(string v)
    {
    ...
    public override bool Equals(object obj) => obj is ValueString24 vs ? this.Equals(vs) : false;

    public bool Equals(ValueString24 other)
    {
    ...
    public static bool operator ==(ValueString24 a, ValueString24 b) => a.Equals(b);
    public static bool operator !=(ValueString24 a, ValueString24 b) => !a.Equals(b);

    public static bool operator ==(ValueString24 a, string b) => a.Equals(b);
    public static bool operator !=(ValueString24 a, string b) => !a.Equals(b);

    public static bool operator ==(string a, ValueString24 b) => b.Equals(a);
    public static bool operator !=(string a, ValueString24 b) => !b.Equals(a);
  }
}
