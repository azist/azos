...
namespace Azos.Pile
{
  ...
  public unsafe struct ValueString16 : IEquatable<ValueString16>, IEquatable<string>
  {
    ...
    public override bool Equals(object obj) => obj is ValueString16 vs ? this.Equals(vs) : false;
    ...
    public static bool operator ==(ValueString16 a, ValueString16 b) => a.Equals(b);
    public static bool operator !=(ValueString16 a, ValueString16 b) => !a.Equals(b);

    public static bool operator ==(ValueString16 a, string b) => a.Equals(b);
    public static bool operator !=(ValueString16 a, string b) => !a.Equals(b);

    public static bool operator ==(string a, ValueString16 b) => b.Equals(a);
    public static bool operator !=(string a, ValueString16 b) => !b.Equals(a);
  }
}
