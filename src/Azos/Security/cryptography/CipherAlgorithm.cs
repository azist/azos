...
{
  /// <summary>
  /// Represents an abstraction of cipher algorithm that performs encryption, decryption, and verification
  /// </summary>
  public abstract class CipherAlgorithm : DaemonWithInstrumentation<ICryptoManagerImplementation>, Collections.INamed
  {
    #region .ctor
      protected CipherAlgorithm(ICryptoManagerImplementation director, string name) : base(director)
      {
        this.Name = name;
