...
namespace Azos.Sky.Chronicle.Server
{
  ...
  /// </summary>
  public interface IInstrumentationChronicleStore : IDaemonView
  {
    Task WriteAsync(InstrumentationBatch data);
    Task<IEnumerable<JsonDataMap>> GetAsync(InstrumentationChronicleFilter filter);
  }

  public interface IInstrumentationChronicleStoreImplementation : IInstrumentationChronicleStore, IDaemon
  {
  }
}
