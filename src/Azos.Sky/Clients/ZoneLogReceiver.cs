...
// it can be used with ServiceClientHub class
  ...
  #region Static Members
     ...
     static ZoneLogReceiver()
     {
         ...
         @s_ms_SendLog_0 = new MethodSpec(t.GetMethod("SendLog", new Type[]{ typeof(@System.@String), typeof(@System.@String), typeof(@Azos.@Log.@Message[]) }));
     }
  #endregion
  ...
  #region Contract Methods
         ...
         ///</summary>
         public @System.@Int32 @SendLog(@System.@String  @host, @System.@String  @appName, @Azos.@Log.@Message[]  @data)
         {
