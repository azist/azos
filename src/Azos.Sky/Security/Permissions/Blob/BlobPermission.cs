...
namespace Azos.Security.Blob
{
  /// <summary>
  /// Defines access levels for BLOB server access
  /// </summary>
  ...
  /// <summary>
  /// Grants the assignee to have desired access level to Blob data
  /// </summary>
  public sealed class BlobPermission : TypedPermission
  {
    ...
    public BlobPermission(BlobAccessLevel level) : base((int)level){ }

    public BlobPermission(BlobAccessLevel level, EntityId target) : base((int)level)
    {
