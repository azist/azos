...
namespace Azos.Sky.Locking.Server
{
  ...
  /// </summary>
  public sealed class LockServerService : DaemonWithInstrumentation<IApplicationComponent>, Contracts.ILocker
  {
    #region CONSTS
    ...
    #region .ctor
    public LockServerService(IApplicationComponent director) : base(director)
    {
    }
    #endregion
