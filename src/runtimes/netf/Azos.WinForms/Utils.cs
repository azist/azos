...
namespace Azos.WinForms
{
  ...
  public static class Utils
  {
    ...
    /// </summary>
    public static void DrawStringWithBackground(System.Drawing.Graphics gr, string text,
                                                Font font,
                                                Brush textBrush,
                                                Brush backBrush,
                                                int x, int y)
    ...
    /// </summary>
    public static void DrawUnderline(System.Drawing.Graphics gr, Point start, int length, Color color)
    {
    ...
    /// </summary>
    public static void DrawUnderlineRectangle(System.Drawing.Graphics gr, Rectangle rect, Color color)
    {
      using (Pen pen = new Pen(color, 2f))
      {
        pen.DashStyle = DashStyle.Dot;
