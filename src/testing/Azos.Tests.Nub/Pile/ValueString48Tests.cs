...
using VALS = Azos.Pile.ValueString48;

namespace Azos.Tests.Nub.Pile
{
  [Runnable]
  public class ValueString48Tests
  {
    private string[] a1;
    private VALS[] a2;
    private Complex[] a3;
    ...
    public void Basic()
    {
      VALS vs = new VALS("012345678901234567890123456789012345678912345678");
      var vs2 = new VALS("012345678901234567890123456789012345678912345678");

      System.Runtime.InteropServices.Marshal.SizeOf<VALS>().See();

      Aver.AreEqual("012345678901234567890123456789012345678912345678", vs.ToString());
    }
    ...
    [Run, Aver.Throws(typeof(AzosException), Message = "Length > 48")]
    public void TooLong()
    {
      var v = new VALS("jpofiaojdfopiafka;lkf;'lksad;lkf;laks;ldkf';lsak'f;lkas'l;;l;l';lf'l';f'sf;lal;f;alkf;kas;lfksjapofijapsojidfpoisajpofjaspojpiaofsdjf");
    }
