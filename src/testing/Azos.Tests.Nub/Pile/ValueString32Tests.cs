...
using VALS = Azos.Pile.ValueString32;
...
namespace Azos.Tests.Nub.Pile
{
  ...
  public class ValueString32Tests
  {
    ...
    public void Basic()
    {
      VALS vs = new VALS("01234567890123456789012345678901");
      var vs2 = new VALS("01234567890123456789012345678901");

      System.Runtime.InteropServices.Marshal.SizeOf<VALS>().See();

      Aver.AreEqual("01234567890123456789012345678901", vs.ToString());
    }
    ...
    [Run, Aver.Throws(typeof(AzosException), Message = "Length > 32")]
    public void TooLong()
    {
      var v = new VALS("jpofiaojdfopisjapofijapsojidfpoisajpofadfpiouoapsudofiuaosufoiausofiuoasufoiuasodiufoasudfusaoufoiasuodfiuaufopiaofuaojaspojpiaofsdjf");
    }
