...
using VALS = Azos.Pile.ValueString64;
...
namespace Azos.Tests.Nub.Pile
{
  ...
  public class ValueString64Tests
  {
    ...
    public void Basic()
    {
      VALS vs = new VALS("1234567890123456789012345678901234567890123456789012345678901234");
      var vs2 = new VALS("1234567890123456789012345678901234567890123456789012345678901234");

      System.Runtime.InteropServices.Marshal.SizeOf<VALS>().See();

      Aver.AreEqual("1234567890123456789012345678901234567890123456789012345678901234", vs.ToString());
    }
    ...
    public void Benchmark()
    {
      ...
      a2 = new VALS[150 * 1024];
      for (var i = 0; i < a2.Length; i++)
        a2[i] = new VALS("1234567890123456789012345678901234567890123456789012345678901234");

      var e2 = sw.ElapsedMilliseconds;

      sw.Restart();

      a3 = new Complex[150 * 1024];
