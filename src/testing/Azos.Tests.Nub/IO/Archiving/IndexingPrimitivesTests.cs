...
namespace Azos.Tests.Nub.IO.Archiving
{
  ...
  public class IndexingPrimitivesTests : CryptoTestBase
  {
    ...
    [Run("!arch-mumbo-write-ms", "compress=gzip   encrypt=aes1   cnt=10000")]// trun Azos.Tests.Nub.dll -r namespaces=*IO.Archiving* names=arch-mumbo-write-ms
    public void Write_To_MemoryStream(string compress, string encrypt, int CNT)
    {
