...
namespace Azos.Tests.Nub.Security
{
  ...
  public class MinIdpTests  : IRunHook
  {
    internal class MockStore : Daemon, IMinIdpStoreImplementation
    {
      ...
      public Task<MinIdpUserData> GetByIdAsync(Atom realm, string id, IAuthenticationRequestContext ctx = null)
      {
      ...
      public Task<MinIdpUserData> GetBySysAsync(Atom realm, string sysToken, IAuthenticationRequestContext ctx = null)
      {
      ...
      public Task<MinIdpUserData> GetByUriAsync(Atom realm, string uri, IAuthenticationRequestContext ctx = null)
      {
