...
namespace Azos.Tests.Nub.Serialization
{
  ...
  public class JazonParserTests
  {
    ...
    public void ParserTest()
    {
      ...
      var got = JazonParser.Parse(src, true, JsonReadingOptions.Default);
    ...
    public void ULongMax()
    {
      ...
      var src = new StringSource(json);
      var got = JazonParser.Parse(src, true, JsonReadingOptions.Default) as JsonDataMap;
    ...
    public void Depth_2()
    {
      var json = @"{ v: 'abc'}";
      var src = new StringSource(json);
      var got = JazonParser.Parse(src, true, new JsonReadingOptions(JsonReadingOptions.Default){ MaxDepth = 1}) as JsonDataMap;
    ...
    public void Depth_3()
    {
      var json = @"{ v: 'abc'}";
      var src = new StringSource(json);
      var got = JazonParser.Parse(src, true, new JsonReadingOptions(JsonReadingOptions.Default) { MaxDepth = 0 }) as JsonDataMap;
    }
    ...
    public void Depth_4()
    {
      var json = @"{ v: {v2: 'abc'}}";
      var src = new StringSource(json);
      var got = JazonParser.Parse(src, true, new JsonReadingOptions(JsonReadingOptions.Default) { MaxDepth = 2 }) as JsonDataMap;
    ...
    public void Depth_6()
    {
      var json = @"123";
      var src = new StringSource(json);
      var got = JazonParser.Parse(src, true, new JsonReadingOptions(JsonReadingOptions.Default) { MaxDepth = 0 });//only allow root values, not objects or arrays
