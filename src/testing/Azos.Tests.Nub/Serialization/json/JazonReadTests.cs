...
namespace Azos.Tests.Nub.Serialization
{
  ...
  public class JazonReadTests
  {
    ...
    {
      var map = JZ.DeserializeFromJson("{ a: 1, b: 2, c: null, d: {a: 'string'}, e: [ - 1000,null, true, -2e3,{msg: 'my message'}]}", null) as JsonDataMap;
      Aver.IsNotNull(map);
    ...
    {
      var got = JZ.DeserializeFromJson("[1,2,3]", null) as JsonDataArray;
      Aver.IsNotNull(got);
    ...
    {
      var got = JZ.DeserializeFromJson("123", null);
      Aver.IsNotNull(got);
    ...
    {
      var got = JZ.DeserializeFromJson("-123000000000", null);
      Aver.IsNotNull(got);
    ...
    {
      var got = JZ.DeserializeFromJson("true", null);
      Aver.IsNotNull(got);
    ...
    {
      var got = JZ.DeserializeFromJson("false", null);
      Aver.IsNotNull(got);
    ...
    {
      var got = JZ.DeserializeFromJson("null", null);
      Aver.IsNull(got);
    }
    ...
    {
      var got = JZ.DeserializeFromJson("'string'", null);
      Aver.IsNotNull(got);
    ...
    {
      var got = JZ.DeserializeFromJson("{}", null) as JsonDataMap;
      Aver.IsNotNull(got);
    ...
    {
      var got = JZ.DeserializeFromJson("[]", null) as JsonDataArray;
      Aver.IsNotNull(got);
      Aver.AreObjectsEqual(0, got.Count);
    }
    ...
    {
      var map = JZ.DeserializeFromJson("{ a: 1, b: -1, c: +2, d: -2, e:  2147483647, f: -2147483647}", null) as JsonDataMap;
      Aver.IsNotNull(map);
    ...
    public void Longs()
    {
      var map = JZ.DeserializeFromJson("{ a: 10000000000, b: -10000000000, c: +20000000000, d: -20000000000, e:  9223372036854775807, f: -9223372036854775807}", null) as JsonDataMap;
      Aver.IsNotNull(map);
      Aver.AreEqual(6, map.Count);
    ...
    public void Doubles()
    {
      var map = JZ.DeserializeFromJson("{ pi: 3.14159265359, exp1: 123e4, exp2: 2e-5, exp3: 2e+3, exp4: -0.2e+2 }", null) as JsonDataMap;
      Aver.IsNotNull(map);
      Aver.AreEqual(5, map.Count);
    ...
    public void Bools()
    {
      var map = JZ.DeserializeFromJson("{ a: true, b: false, c: null}", null) as JsonDataMap;
      Aver.IsNotNull(map);
    ...
    {
      var map = JZ.DeserializeFromJson(@"{ a: ''}", null) as JsonDataMap;
      Aver.IsNotNull(map);
      Aver.AreEqual(1, map.Count);
    ...
    {
      var map = JZ.DeserializeFromJson(@"{ a: '', b: """"}", null) as JsonDataMap;
      Aver.IsNotNull(map);
