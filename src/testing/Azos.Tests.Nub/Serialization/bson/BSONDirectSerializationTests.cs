...
namespace Azos.Tests.Nub.Serialization
{
  ...
  public class BSONDirectSerializationTests
  {
    ...
    public class TypicalData : IBSONDeserializable, IBSONSerializable
    {
      ...
      public const string BSON_FLD_TRUE = "True";
      public bool False { get; set; }
      public const string BSON_FLD_FALSE = "False";
      public char CharMin { get; set; }
      public const string BSON_FLD_CHARMIN = "CharMin";
      public char CharMax { get; set; }
      public const string BSON_FLD_CHARMAX = "CharMax";
      public sbyte SByteMin { get; set; }
      public const string BSON_FLD_SBYTEMIN = "SByteMin";
      public sbyte SByteMax { get; set; }
      public const string BSON_FLD_SBYTEMAX = "SByteMax";
      public byte ByteMin { get; set; }
      public const string BSON_FLD_BYTEMIN = "ByteMin";
      public byte ByteMax { get; set; }
      public const string BSON_FLD_BYTEMAX = "ByteMax";
      public short Int16Min { get; set; }
      public const string BSON_FLD_INT16MIN = "Int16Min";
      public short Int16Max { get; set; }
      public const string BSON_FLD_INT16MAX = "Int16Max";
      public ushort UInt16Min { get; set; }
      public const string BSON_FLD_UINT16MIN = "UInt16Min";
      public ushort UInt16Max { get; set; }
      public const string BSON_FLD_UINT16MAX = "UInt16Max";
      public int Int32Min { get; set; }
      public const string BSON_FLD_INT32MIN = "Int32Min";
      public int Int32Max { get; set; }
      public const string BSON_FLD_INT32MAX = "Int32Max";
      public uint UInt32Min { get; set; }
      public const string BSON_FLD_UINT32MIN = "UInt32Min";
      public uint UInt32Max { get; set; }
      public const string BSON_FLD_UINT32MAX = "UInt32Max";
      public long Int64Min { get; set; }
      public const string BSON_FLD_INT64MIN = "Int64Min";
      public long Int64Max { get; set; }
      public const string BSON_FLD_INT64MAX = "Int64Max";
      public ulong UInt64Min { get; set; }
      public const string BSON_FLD_UINT64MIN = "UInt64Min";
      public ulong UInt64Max { get; set; }
      public const string BSON_FLD_UINT64MAX = "UInt64Max";
      public float SingleEps { get; set; }
      public const string BSON_FLD_SINGLEEPS = "SingleEps";
      public float SingleMin { get; set; }
      public const string BSON_FLD_SINGLEMIN = "SingleMin";
      public float SingleMax { get; set; }
      public const string BSON_FLD_SINGLEMAX = "SingleMax";
      public float SingleNaN { get; set; }
      public const string BSON_FLD_SINGLENAN = "SingleNaN";
      public float SinglePosInf { get; set; }
      public const string BSON_FLD_SINGLEPOSINF = "SinglePosInf";
      public float SingleNegInf { get; set; }
      public const string BSON_FLD_SINGLENEGINF = "SingleNegInf";
      public double DoubleEps { get; set; }
      public const string BSON_FLD_DOUBLEEPS = "DoubleEps";
      public double DoubleMin { get; set; }
      public const string BSON_FLD_DOUBLEMIN = "DoubleMin";
      public double DoubleMax { get; set; }
      public const string BSON_FLD_DOUBLEMAX = "DoubleMax";
      public double DoubleNaN { get; set; }
      public const string BSON_FLD_DOUBLENAN = "DoubleNaN";
      public double DoublePosInf { get; set; }
      public const string BSON_FLD_DOUBLEPOSINF = "DoublePosInf";
      public double DoubleNegInf { get; set; }
      public const string BSON_FLD_DOUBLENEGINF = "DoubleNegInf";
      public decimal DecimalMin { get; set; }
      public const string BSON_FLD_DECIMALMIN = "DecimalMin";
      public decimal DecimalMax { get; set; }
      public const string BSON_FLD_DECIMALMAX = "DecimalMax";
      public decimal DecimalZero { get; set; }
      public const string BSON_FLD_DECIMALZERO = "DecimalZero";
      public decimal DecimalOne { get; set; }
      public const string BSON_FLD_DECIMALONE = "DecimalOne";
      public decimal DecimalMOne { get; set; }
      public const string BSON_FLD_DECIMALMONE = "DecimalMOne";
      public DateTime DateTimeMin { get; set; }
      public const string BSON_FLD_DATETIMEMIN = "DateTimeMin";
      public DateTime DateTimeMax { get; set; }
      public const string BSON_FLD_DATETIMEMAX = "DateTimeMax";
      public DateTime DateTimeNow { get; set; }
      public const string BSON_FLD_DATETIMENOW = "DateTimeNow";
      public DateTime DateTimeUtc { get; set; }
      public const string BSON_FLD_DATETIMEUTC = "DateTimeUtc";
      public TimeSpan TimeSpanMin { get; set; }
      public const string BSON_FLD_TIMESPANMIN = "TimeSpanMin";
      public TimeSpan TimeSpanMax { get; set; }
      public const string BSON_FLD_TIMESPANMAX = "TimeSpanMax";
      public string StringEmpty { get; set; }
      public const string BSON_FLD_STRINGEMPTY = "StringEmpty";
      public string StringNull { get; set; }
      public const string BSON_FLD_STRINGNULL = "StringNull";
      public string String { get; set; }
      public const string BSON_FLD_STRING = "String";
    ...
    public void SerializeTypicalData()
    {
      ...
      doc.ToJson(JsonWritingOptions.PrettyPrint).See();
